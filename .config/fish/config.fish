...
source /home/akame/.config/fish/cyber.fish
...
alias checkpoint='git add . && git commit -m "checkpoint"'
alias rl='readlink -f'
alias r='ranger'
alias n='nvim'
alias nv='nvim .'
...
alias cfg='cd ~/.config/'
alias diff='difft'
alias cargo_build_win="cargo build --target x86_64-pc-windows-gnu"
...
# Created by `pipx` on 2024-08-27 14:44:15
set PATH $PATH /home/akame/.local/bin
